...
# Default FOLDERCHAT_VERSION, typically overriden during builds by GitHub Actions.
ARG FOLDERCHAT_VERSION=0.3-dev
ENV FOLDERCHAT_VERSION=${FOLDERCHAT_VERSION}
RUN echo "FOLDERCHAT_VERSION: ${FOLDERCHAT_VERSION}"
